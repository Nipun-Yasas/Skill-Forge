...
export const Header = () => {
  return (
    <div className="relative w-[1130px] mb-10 h-44 rounded-[19px] overflow-hidden shadow-[0px_4px_10px_-3px_rgba(0,0,0,0.83),-4px_4px_10px_-3px_rgba(0,0,0,0.06)]">
    <div className="inline-flex flex-wrap items-center justify-start gap-10 relative">
      ...
      <div className="flex gap-4 mt-8 mb-3 ml-10 mr-10">
