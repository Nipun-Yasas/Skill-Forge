...
const GoogleButton = () => {
  return (
    <button className="flex gap-4 justify-center items-center w-full bg-white rounded-xl shadow h-[54px]">
      <svg
        width="25"
        height="24"
        viewBox="0 0 25 24"
      ...
      <span className="text-xl font-medium text-black text-opacity-50">
        Log In with Google
      </span>
    </button>
  );
